...
def lumped(calor, fg, area_rad, nos, K_m, nos_ext):
    ...
    while n < numero_orbitas:
        ...
        import csv
        with open(f'./results_{i}/Temperaturas_{i}/resultado_temp_{n}.csv', 'w', newline='') as arquivo_csv:
...
for i in range():
    ...
    createFolder(f'./results_{i}/Temperaturas_{i}')
    # matriz com as radiações externas incidentes

    # calor obtido da simulacao orbital
    calor = pd.read_csv(f'./results_{i}/radiacao_{i}/Calor_Incidente.csv', sep=',')
