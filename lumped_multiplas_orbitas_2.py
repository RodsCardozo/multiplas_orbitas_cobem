...
e=0.557
"""
substrato1 = Substrato('1', 'substrato 1',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato2 = Substrato('2', 'substrato 2',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato3 = Substrato('3', 'substrato 3',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato4 = Substrato('4', 'substrato 4',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato5 = Substrato('5', 'substrato 5',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato6 = Substrato('6', 'substrato 6',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato7 = Substrato('7', 'substrato 7',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
substrato8 = Substrato('8', 'substrato 8',Lx=0.002, vol=0.000002696, area=0.002696, a=0.578, e=0.557, rho=2330., k=148.9, cp=712.8, area_rad=0.002696)
...
a = 0.13
"""
tampa1 = Tampa('17', 'Tampa 1', vol=0.00002914719, n='k', e=0.76, a=0.07, rho=1850, k=0.81, cp=1100.0, area_rad=0.00971573)
tampa2 = Tampa('18', 'Tampa 2', vol=0.00002914719, n='k', e=0.76, a=0.07, rho=1850, k=0.81, cp=1100.0, area_rad=0.00971573)
...
def lumped(calor, fg, area_rad, nos, K_m, beta):
    ...
    while n < numero_orbitas:
        ...
        import csv
        with open(f'Transiente2/beta{beta}/resultado_temp_{n}.csv', 'w', newline='') as arquivo_csv:
...
for I in range(1, len(beta)):
    ...
    createFolder(f'Transiente2/beta{beta[I]}')
    lumped(calor2, rad, area_rad, nos, K_m, beta[I])
